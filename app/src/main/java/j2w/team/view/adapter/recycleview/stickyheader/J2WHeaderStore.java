 ...
 * @类描述
 */
public class J2WHeaderStore {

    private final RecyclerView parent;
    private final J2WStickyHeaders adapter;
    ...
    public J2WHeaderStore(RecyclerView parent, J2WStickyHeaders adapter, boolean isSticky) {
        this.parent = parent;
    ...
    public View getHeaderViewByItem(RecyclerView.ViewHolder itemHolder) {
        int itemPosition = RecyclerViewHelper.convertPreLayoutPositionToPostLayout(parent, itemHolder.getAdapterPosition());
