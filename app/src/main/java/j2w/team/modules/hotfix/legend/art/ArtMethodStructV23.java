...
public class ArtMethodStructV23 extends ArtMethod {
	...
	@StructMapping(offset = 0) public/* pointer */StructMember	declaring_class_;

	/**
	 * Short cuts to declaring_class_->dex_cache_ member for fast compiled code
	 * access.
	 */
	@StructMapping(offset = 4) public/* pointer */StructMember	dex_cache_resolved_methods_;

	/**
	 * Short cuts to declaring_class_->dex_cache_ member for fast compiled code
	 * access.
	 */
	@StructMapping(offset = 8) public/* pointer */StructMember	dex_cache_resolved_types_;

	@StructMapping(offset = 12) public/* uint32_t */StructMember	access_flags_;

	/**
	 * Dex file fields. The defining dex file is available via
	 * declaring_class_->dex_cache_
	 */
	@StructMapping(offset = 16) public/* uint32_t */StructMember	dex_code_item_offset_;

	/**
	 * Index into method_ids of the dex file associated with this method.
	 */
	@StructMapping(offset = 20) public/* uint32_t */StructMember	dex_method_index_;
	 ...
	 */
	@StructMapping(offset = 24) public/* uint32_t */StructMember	method_index_;

	/**
	 * Method dispatch from the interpreter invokes this pointer which may cause
	 * a bridge into compiled code.
	 */
	@StructMapping(offset = 28) public/* pointer */StructMember	entry_point_from_interpreter_;

	/**
	 * Pointer to JNI function registered to this method, or a function to
	 * resolve the JNI function.
	 */
	@StructMapping(offset = 32) public/* pointer */StructMember	entry_point_from_jni_;
	 ...
	 */
	@StructMapping(offset = 36) public/* pointer */StructMember	entry_point_from_quick_compiled_code_;
