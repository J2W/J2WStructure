...
public class J2WStructureManage implements J2WStructureIManage {
     ...
     */
    @Override
    public <D> Object getImplClass(@NotNull Class<D> service, Object ui) {
    ...
    @Override
    public <B extends J2WIBiz> B common(Class<B> service) {
    ...
    @Override
    public <T> T createMainLooper(final Class<T> service, final Object ui) {
        J2WCheckUtils.validateServiceInterface(service);
        return (T) Proxy.newProxyInstance(service.getClassLoader(), new Class<?>[]{service}, new InvocationHandler() {
            ...
            public Object invoke(Object proxy, final Method method, final Object[] args) throws Throwable {
                final String key = J2WMethodInfo.getMethodString(service, method, method.getParameterTypes());
    ...
    @Override
    public boolean onKeyBack(int keyCode, FragmentManager fragmentManager, J2WActivity bj2WActivity) {
